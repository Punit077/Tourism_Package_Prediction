...
model_path = hf_hub_download(repo_id="Punit0205/Tourism-Package-Model", filename="best_tourism_prediction_model_v1.joblib")
...
DurationOfPitch = st.number_input("Duration Of Pitch", min_value=1, max_value=1000, value=30)
